...
import { loadLevel } from "../assets/scripts/core/level.js";
...
async function testLevel001() {
    const cfg = await loadJson("assets/resources/levels/level_001.json");
...
async function testLevel002() {
    const cfg = await loadJson("assets/resources/levels/level_002.json");
    const loaded = loadLevel(cfg);
